...
import {
    Scheduler, WeekView, Appointments, AppointmentForm, Toolbar, DateNavigator, DragDropProvider, DayView, ViewSwitcher
    ...
    render() {
        ...
        return (
            <Grid item xs={12} style={{ marginBottom: '25px', paddingLeft: '25px' }}>
                ...
                {hasErrored && <Error />}
                <Scheduler
                    data={filterTasks(nextItems, this.state.currentRoom)}
                    height={820}
                >
                    <ViewState
